...
int main() {
    ...
    vector<string>xxx = 
    { "a","p","=","o",";","b","p",",","p",",","p",";","c","p",";",
        "b","p",";","e","p","d","p","r","o",";","p","d","p","r","o",";",
        "h","p","q","p","i","p","d","p","s","p","f",";","e","m","(","p",",","p",
        ")",";","n","(","p",",","p",",","p",")",";","j","p",";","k","g","p","l",
        "p","d","s","p","s","o","f",
    ...
    vector<string>xxx_n =
    {
        "const","a","=","10",";","var","d",",","e",",","f",";",
        "procedure","p",";","var","g",";","begin","d",":=","a","*","2",";","e",
        ":=","a","/","3",";","if","d","<=","e","then","f",":=","d","+","e","end",";",
        "begin","read","(","e",",","f",")",";","write","(","e",",","f",",","d",")",";","call","p",";",
        "while","odd","d","do","e",":=","-","e","+","1","end",
        "!","#"
    };
