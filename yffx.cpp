...
int main() {
    ...
    { "a","p","=","o",";","b","p",",","p",";",
        "c","p",";","b","p",";","e","p","d","o",";",
        "p","d","o",";","k","p","s","p","l","e","h","p","r",
        "p","r","p","s","p","i","e","p","d","o",";","p","d","p",
        "f",";","p","d","p","q","o","f","f",";","c","p",";","e","p",
        "d","o",";","k","p","s","p","l","e","j","p",";","h","p","s","o",
        "i","n","(","p",")",";","p","d","p","q","o","f","f",";","j","p",
        "!","#"
    };
    vector<string>xxx_n =
    {
       "const","max","=","100",";","var","arg",",","ret",";","procedure",
       "isprime",";","var","i",";","begin","ret",":=","1",";","i",":=","2",";"
       ,"while","i","<","arg","do","begin","if","arg","/","i","*","i","==","arg",
        "then","begin","ret",":=","0",";","i",":=","arg","end",";","i",":=","i","+","1",
        "end","end",";","procedure","primes",";","begin","arg",":=","2",";","while","arg","<",
        "max","do","begin","call","isprime",";","if","ret","==","1","then","write","(","arg",")",
        ";","arg",":=","arg","+","1","end","end",";","call","primes",
        "!","#"
    };
